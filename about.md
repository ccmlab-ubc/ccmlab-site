...
#### Lab manual
For more details on the lab philosophy, expectations, and day-to-day matters the CCM Lab manual is available [here](https://ccmlab-ubc.github.io/lab-manual/intro.html). 
